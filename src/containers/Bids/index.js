...
class OrderBookContainer extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: cn }, bidsLoading ? React.createElement(ClipLoader, {sizeUnit: "px", size: 35, loading: true, color: "var(--accent)"}) : this.orderBook(sortBids(bids), asks)));
    }
}

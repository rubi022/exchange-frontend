...
class LegalDocuments extends React.Component {
    ...
    render() {
        return (React.createElement(Modal, { className: 'parent-legal-docs-modal', show: this.props.isOpen, header: React.createElement("h3", null, "Title"), content: this.renderModalBody(), footer: this.props.footer }));
    }
}

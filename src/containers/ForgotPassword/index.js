...
class ForgotPasswordComponent extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "parent-forgot-password-screen" },
            React.createElement("div", { className: "parent-forgot-password-screen__container" },
                React.createElement("div", { className: "parent-forgot-password___form" },

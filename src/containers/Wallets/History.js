...
export class WalletTable extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "parent-history-elem__wallet" },
            React.createElement("div", { className: "parent-history-elem__label" }, this.props.intl.formatMessage({ id: `page.body.history.${label}` })),

...
export class MarketsTabsComponent extends React.Component {
    constructor(props) {
        ...
        this.fastSearchButtons = () => {
            ...
            return (React.createElement("div", { className: "parent-trading-header-fast-search-container", onWheel: this.handleOnMouseWheel, ref: this.tabsRef }, listOfQuote.map(this.renderFastSearchButton)));
        };

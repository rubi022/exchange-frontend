...
class MarketsListComponent extends React.Component {
    constructor(props) {
        ...
        this.getHeaders = () => [
            ...
            const classname = classnames({
                'parent-dropdown-markets-list-container__header-selected': obj.selected,
            });
            const arrowClassname = classnames({
                'parent-dropdown-markets-list-container__arrow-down': !(obj.id === sortBy && !reverseOrder),
                'parent-dropdown-markets-list-container__arrow-up': obj.id === sortBy && !reverseOrder,
            });
    ...
    render() {
        ...
        return (React.createElement("div", { className: "parent-dropdown-markets-list-container" },
    ...
    mapMarkets() {
        ...
        return marketsMapped.reduce((pV, cV) => {
            ...
            return [
                market.name,
                (React.createElement("span", { className: classname }, Decimal.format(Number(market.last), market.amount_precision))),
                (React.createElement("span", { className: classname }, Decimal.format(Number(market.vol), market.amount_precision))),

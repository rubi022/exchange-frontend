...
class SignUpComponent extends React.Component {
    constructor() {
        ...
        this.renderModalHeader = () => {
            return (React.createElement("div", { className: "parent-exchange-modal-submit-header" }, this.props.intl.formatMessage({ id: 'page.header.signUp.modal.header' })));
        };
        this.renderModalBody = () => {
            return (React.createElement("div", { className: "parent-exchange-modal-submit-body" },
                React.createElement("h2", null, this.props.intl.formatMessage({ id: 'page.header.signUp.modal.body' }))));
        };
        this.renderModalFooter = () => {
            return (React.createElement("div", { className: "parent-exchange-modal-submit-footer" },
                React.createElement(Button, { className: "parent-exchange-modal-submit-footer__button-inverse", label: "OK", onClick: this.closeModal })));
        };
        this.closeModal = () => {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "parent-sign-up-screen" },

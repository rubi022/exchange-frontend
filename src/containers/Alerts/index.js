...
class AlertComponent extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "parent-alerts" }, this.props.alerts.alerts.map(w => {
            if(!w.message) return;
            return w.message.map((msg, index) => React.createElement(FadeIn, { key: index },
                React.createElement("div", { onClick: () => this.deleteAlertByIndex(index) },
                    React.createElement(Alert, {
                        // description: w.code && w.code.toString(10),
                        title: this.translate(msg), type: w.type }))))
        })));
    }
}

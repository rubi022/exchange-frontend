...
class ToggleTwoFactorAuthComponent extends React.Component {
    constructor() {
        ...
        this.renderToggle2fa = (enable2fa) => {
            ...
            return (React.createElement("div", { className: "parent-profile-two-factor-auth__form" },
                React.createElement("div", { className: "parent-profile-two-factor-auth__header" },
                    React.createElement("div", null),
                    React.createElement("div", { className: "parent-profile-two-factor-auth__title" }, this.translate('page.body.profile.header.account.content.twoFactorAuthentication.header')),
                    React.createElement("div", { className: "base-email-form__cros-icon", onClick: this.goBack },
                        React.createElement("img", { src: require('./close.svg')}))),
                React.createElement("div", { className: "parent-profile-two-factor-auth__body" },
                    React.createElement("div", { className: "parent-profile-two-factor-auth__body--text" },
                        React.createElement("div", { className: "parent-profile-two-factor-auth__body--text--group" },
                    ...
                    React.createElement("div", { className: "parent-profile-two-factor-auth__body--barcode" }, enable2fa && this.renderTwoFactorAuthQR(barcode))),
                React.createElement("div", { className: "parent-profile-two-factor-auth__copyablefield" }, enable2fa && secret && this.renderSecret(secret)),
                React.createElement("div", { className: "parent-profile-two-factor-auth__body" },
                    React.createElement("div", { className: "parent-profile-two-factor-auth__body--text--last" },
                        React.createElement("div", { className: "parent-profile-two-factor-auth__body--text--group" },
                    ...
                    React.createElement("fieldset", { className: "parent-profile-two-factor-auth__body--input" },
                ...
                React.createElement(Button, { className: "parent-profile-two-factor-auth__button", label: this.translate('page.body.profile.header.account.content.twoFactorAuthentication.enable'), onClick: submitHandler })));
        };
    ...
    render() {
        const enable2fa = this.get2faAction();
        return (React.createElement("div", { className: "parent-profile-two-factor-auth" }, this.renderToggle2fa(enable2fa)));
    }
    ...
    renderTwoFactorAuthQR(barcode) {
        ...
        return barcode.length > 0 && React.createElement("img", { className: "parent-profile-two-factor-auth__qr", src: src });
    }
    renderSecret(secret) {

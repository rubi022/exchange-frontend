...
describe('WalletItem', () => {
    describe('#render', () => {
        it('uses styles by default', () => {
            const wrapper = mount(React.createElement(WalletItem, { address: 'aevrv', currency: 'BTC', 
                // tslint:disable-next-line:no-magic-numbers
                balance: 45, 
                // tslint:disable-next-line:no-magic-numbers
                locked: 3, 
                // tslint:disable-next-line:no-magic-numbers
                fee: 0.3, type: 'fiat', active: false }));
        ...
        it('should not display locked balance if wallet does not have one', () => {
            const wrapper = shallow(React.createElement(WalletItem, { address: 'aevrv', currency: 'BTC', 
                // tslint:disable-next-line:no-magic-numbers
                balance: 45, 
                // tslint:disable-next-line:no-magic-numbers
                fee: 0.3, type: 'fiat', active: false }));
            ...
            expect(balanceElement.props().className)
                .not.toContain('base-wallet-item__balance-locked');
        });
        ...
        it('should render when locked = 0', () => {
            const wrapper = shallow(React.createElement(WalletItem, { address: 'aevrv', currency: 'BTC', locked: 0, 
                // tslint:disable-next-line:no-magic-numbers
                fee: 0.3, type: 'fiat', active: true, 
                // tslint:disable-next-line:no-magic-numbers
                balance: 45 }));

...
class SignIn extends React.Component {
  constructor() {
    ...
    this.renderSignInForm = () => {
      ...
      return React.createElement(SignInComponent, {
        ...
        signUpText: this.props.intl.formatMessage({ id: "page.signIn.signup" }),
        signUpExists: this.props.intl.formatMessage({ id: "page.signIn.signupExists" }),
    ...
    this.render2FA = () => {
      ...
      return React.createElement(TwoFactorAuth, {
        isLoading: loading,
    ...
    this.handleSignIn = () => {
      ...
      if (captchaType() === "recaptcha" && recaptchaConfirmed !== true) return;
      this.props.signIn({
        email,
        password,
        otp_code: otpCode,
  ...
  componentDidMount() {
    ...
    setDocumentTitle(
      this.props.intl.formatMessage({ id: "page.header.navbar.signIn" })
    );
  ...
  render() {
    ...
    const className = cx("parent-sign-in-screen__container", { loading });
    return (
      <div
        className="page-ath-wrap pt-5 pb-5 d-flex justify-content-start align-items-center flex-column"
      >
        {/*<AuthBrand />*/}
        <div className="page-ath-content" style={{ color: "black !important" }}>
          {this.renderSignInForm()}
        </div>

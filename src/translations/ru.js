...
export const ru = {
    ...
    'page.body.profile.kyc.content': 'To comply with regulation, participant will have to go through indentity verification.',
    'page.body.profile.kyc.content.notice': "* KYC verification required for trading",
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.message.2': 'Отсканируйте QR код или используйте код:',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.message.mfa': 'используйте код',
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
    ...
    "page.header.signUp.usernameLength.message.error": "Имя пользователя должно состоять минимум из 4 и максимум из 20 символов.",
    ...
    "page.forgotPassword.description": "Enter your email address below to reset password.",
    ...
    'page.body.wallets.tabs.withdraw.form.beneficiaryPlaceHolder': 'Select Beneficiary',

...
const Balance = ({ user, setUser }) => {
    const url = "https://cp.btfd.cc/api/v2/barong/resource/users/password";
    ...
    useEffect(() => {
        ...
        async function getBalanceData() {
            ...
            if (!response.ok) {
                ...
                console.log(`it worked: ${response.status} - ${response.statusText}`);
                                ...
                                <div className="row mt-4 profile-list-row">
                                    <div className="col-xl-12 col-md-12 profile-list-div">
                                        ...
                                        <ul className="list-group">
                                            <li className="list-group-item list-group-item-secondary" aria-current="true">My Balance</li>
                                            <li className="list-group-item text-center">show: </li>

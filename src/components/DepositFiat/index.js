...
const DepositFiat = (props) => {
    ...
    const renderDetails = (detail, index) => {
        return (React.createElement("div", { className: "base-deposit-fiat-detail", key: index },
            React.createElement("p", { className: "base-deposit-fiat-detail__label" },
                detail.key,
                ":"),
    ...
    return (React.createElement("div", { className: "base-deposit-fiat" },
        ...
        React.createElement("div", { className: "base-deposit-fiat-credentials" }, bankData.map(renderDetails))));
};
export { DepositFiat, };
